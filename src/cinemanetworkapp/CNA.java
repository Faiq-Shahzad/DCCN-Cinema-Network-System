...
/**
 *
 * @author MUHAMMAD AHMED && FAIQ SHAHZAD
 */
public class CNA {
    ...
    public static void main(String[] args) throws ClassNotFoundException, InterruptedException, ParseException {
        ...
        //creating Client
        myClient = new client(5001,7000,IPAddress);
                                ...
                                if (userIn == 4) {
                                    ...
                                    if(currentUser.equals("admin")){
                                        ...
                                        try{
                                            ...
                                            String date_in = input.next().trim();

                                            if (!date_in.matches("^(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\\d\\d")){
                                                System.out.println(date_in);
                                                throw new Exception();
                                            }

                                            Date ticketDate = new SimpleDateFormat("dd/mm/yyyy").parse(date_in);
